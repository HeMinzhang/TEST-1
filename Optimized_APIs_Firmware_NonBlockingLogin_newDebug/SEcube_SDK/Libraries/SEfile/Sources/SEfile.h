...
///@}
/** @}*/
/** \defgroup whence whence parameter for secure_seek
 * @{
 */
...
/** The amount of Overhead created by \ref SEFILE_SECTOR::len, \ref SEFILE_SECTOR::padding and \ref SEFILE_SECTOR::signature */
#define SEFILE_SECTOR_OVERHEAD 		(SEFILE_SECTOR_SIZE-SEFILE_LOGIC_DATA)									//16 byte (sign+len+padd)
///@}
/** @}*/
 ...
 *				See \ref AlgorithmAvail, it can be SE3_ALGO_MAX + 1 if 
 ...
 * @param [in] mode The mode in which the file should be opened. See \ref mode.
 ...
 * @param [in] mode The mode in which the file should be created. See \ref mode.
 * @return The function returns a (uint16_t) '0' in case of success.
 *         See \ref errorValues for error list.
 */
 ...
 * @param [out] bytesRead Number of effective characters read.
 * @return The function returns a (uint16_t) '0' in case of success.
 *         See \ref errorValues for error list.
 */
